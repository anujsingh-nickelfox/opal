    ...
    <div >
       <div className="border-brand/10 relative mx-auto my-6 flex h-[336px] max-w-[250px] flex-col items-start border p-4 md:h-[28rem] md:max-w-sm">
                        ...
                        <ImageZoom>
                            ...
                            <img
                                src="https://ik.imagekit.io/yrpp2zi5o/1000079928~2.jpg?updatedAt=1775317290256"
                                alt="Your Image"
                            ...
                            <div className="relative -mt-14 bg-gradient-to-b from-black/0 to-black text-white md:-mt-24">
                                <h1 className="z-20 items-center text-center text-[40px] font-black tracking-tighter md:text-[70px]">Anuj Singh</h1>{' '}
                            </div>
                        </ImageZoom>
                    </div>
    </div>
